# Generated by Powerlevel10k configuration wizard on 2025-05-05 at 16:04 SAST.
...
# disconnected, right frame, blue-ornaments, sparse, few icons, concise,
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  typeset -g POWERLEVEL9K_DIR_VISUAL_IDENTIFIER_EXPANSION=$'\UF07C '
  ...
  typeset -g POWERLEVEL9K_DIR_HOME_VISUAL_IDENTIFIER_EXPANSION=$'\UF015 '
  ...
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='\UF418 '
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_NODE_VERSION_VISUAL_IDENTIFIER_EXPANSION=$'\UE718'
